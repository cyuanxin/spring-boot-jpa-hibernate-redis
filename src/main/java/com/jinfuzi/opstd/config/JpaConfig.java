...
class JpaConfig implements TransactionManagementConfigurer {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        entityManagerFactoryBean.setPackagesToScan("com.jinfuzi.opstd");
        entityManagerFactoryBean.setJpaVendorAdapter(new HibernateJpaVendorAdapter());

        Properties jpaProperties = new Properties();
        jpaProperties.put(org.hibernate.cfg.Environment.DIALECT, dialect);
        jpaProperties.put(org.hibernate.cfg.Environment.HBM2DDL_AUTO, hbm2ddlAuto);
        jpaProperties.put("hibernate.cache.region.factory_class", cacheFactoryClass);
        jpaProperties.put("hibernate.cache.use_second_level_cache", useSecondLevelCache);
        jpaProperties.put("hibernate.cache.use_query_cache", useQueryCache);
        jpaProperties.put("javax.persistence.sharedCache.mode", "ALL");
        jpaProperties.put("org.hibernate.cacheable", true);
